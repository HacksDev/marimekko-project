export const BottomNavigation = () => {
    return <section id="bottom-navigation"
             className="block bg-neutral text-neutral-content md:hidden sm:block  fixed inset-x-0 bottom-0 z-10 bg-white shadow">
                ...
                <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1">
                    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        ...
                        <rect fill="currentColor"
                              ...
                              x="17" y="10.3137085" width="30" height="2" rx="1"/>
                        <rect fill="currentColor"
                              transform="translate(12.000000, 11.313708) rotate(-45.000000) translate(-12.000000, -11.313708) "
                              x="-3" y="10.3137085" width="30" height="2" rx="1"/>
                    </g>
                </svg>
                <span className="tab tab-xs tab-home  text-neutral-content block text-xs">Home</span>
            </a>
            <a href="#"
               className="w-full text-neutral-content focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1">
                    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        <path
